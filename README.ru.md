...
**Ошибки парсинга.** Если в header'е outline есть строка `# WARNING: N
parse errors — output may be incomplete`, в файле есть синтаксические
дыры — считай outline для этого файла частичным и читай исходник
напрямую для затронутой области, прежде чем что-то менять.
